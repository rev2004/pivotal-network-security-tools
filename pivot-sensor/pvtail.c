...
/*
   ...
   Title : Pivotal NST Sensor Tail IDS Logs
   Author: Derek Chadwick
   Date  : 06/07/2014

   Purpose: Pivotal Sensor functions for tailing IDS logs. Options are
            ...
            events then send the events to the Pivotal Server or writes
